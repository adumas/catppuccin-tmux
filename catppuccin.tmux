...
main() {
  ...
  readonly powerline_window_number_current="#[fg=$thm_orange,bg=$thm_gray]#[bold]#I#[fg=$thm_gray,bg=$thm_orange]"
  ...
  readonly show_directory_in_window_status_current="$powerline_window_number_current#[fg=$thm_gray,bg=$thm_orange]#{b:pane_current_path}#[fg=$thm_orange,bg=$thm_gray]"
