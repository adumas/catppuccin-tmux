...
main() {
  ...
  local powerline_window_number
  readonly powerline_window_number="#[fg=$thm_bg,bg=$thm_blue]#I#[fg=$thm_blue,bg=$thm_gray]"
  
  local powerline_window_number_current
  readonly powerline_window_number_current="#[fg=$thm_bg,bg=$thm_orange]#I#[fg=$thm_orange,bg=$thm_gray]"
  ...
  readonly show_directory_in_window_status_current="$powerline_window_number_current #{b:pane_current_path} "
  ...
  local show_host
  readonly show_host="#[fg=$thm_blue,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_blue]󰢩 #[fg=$thm_fg,bg=$thm_gray] #h "

  local show_date_time
  readonly show_date_time="#[fg=$thm_blue,bg=$thm_gray]$right_separator#[fg=$thm_bg,bg=$thm_blue,bold] $date_time "
